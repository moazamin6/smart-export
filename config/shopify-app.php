...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'OrderStalker'),
...
//    'api_key' => env('SHOPIFY_API_KEY', '8e592ef87b048ad741f40a39550186b3'),
...
//    'api_secret' => env('SHOPIFY_API_SECRET', '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'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_customers,read_products,read_orders'),
    ...
    'webhooks' => [
        ...
        */
        [
            ...
            'address' => 'https://latest.orderstalker.com/webhook/app-uninstalled'
        ],
